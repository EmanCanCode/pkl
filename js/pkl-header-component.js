...
(function () {
  ...
  const NAV_ITEMS = [
    ...
    { label: "Sponsors", href: "sponsors.html" },
    {
      ...
      children: [
        ...
        { label: "Profile Image", href: "#" },
        { label: "Merchandise", href: "#" },
        { label: "Equipment", href: "#" },
      ],
    },
    { label: "PKL.CLUB", href: "pkl-club.html" },
  ...
  const PAGE_TO_NAV = {
    ...
    "pkl-club.html": "PKL.CLUB",
    "news.html": "News",
    "blog-details.html": "News",
    "admin-dashboard.html": "Dashboard",
    "operator-dashboard.html": "Dashboard",
    "player-dashboard.html": "Dashboard",
    "index.html": "",
    "shop-products.html": "Shop",
    "shop-products-sidebar.html": "Shop",
    "shop-product-details.html": "Shop",
    "shop-cart.html": "Shop",
    "shop-checkout.html": "Shop",
  };

  // Roles that hide specific nav items
  const HIDDEN_NAV_BY_ROLE = {
    player: ["Players", "Operators", "Sponsors"],
    operator: ["Players", "Operators", "Sponsors"],
    sponsor: ["Players", "Operators", "Sponsors"],
    admin: ["Players", "Operators", "Sponsors"],
  };
